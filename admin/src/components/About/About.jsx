        ...
        <Box>
          <Flex direction="column" alignItems="start" gap={4}>
            <Flex direction="column" alignItems="start" gap={2}>
              ...
              <Typography>
                {i18n({
                  ...
                  defaultMessage:
                    'This is a fork of the original Strapi 4 plugin, converted to Strapi 5.',
                })}
              </Typography>
              <Flex direction="row" gap={4}>
                <Link href="https://github.com/Prototypr/import-export-entities" isExternal>
                  GitHub (Strapi 5)
                </Link>
            ...
            <Flex direction="column" alignItems="start" gap={2} marginTop={4}>
              ...
              <Flex gap={4}>
                <Link href="https://import-export-entities-entries.canny.io" isExternal>
                  {i18n({
